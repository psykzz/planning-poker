...
For an existing database, apply [supabase/migrations/20260730195700_add_round_labels.sql](supabase/migrations/20260730195700_add_round_labels.sql) to add the round label column without recreating tables.
