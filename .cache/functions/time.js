...
const nodeFetch = __webpack_require__(6292)
...
/* unused reexport */ __webpack_require__(5341).serializeURL;
/* unused reexport */ __webpack_require__(5341).serializeURLOrigin;
/* unused reexport */ __webpack_require__(5341).basicURLParse;
/* unused reexport */ __webpack_require__(5341).setTheUsername;
/* unused reexport */ __webpack_require__(5341).setThePassword;
/* unused reexport */ __webpack_require__(5341).serializeHost;
/* unused reexport */ __webpack_require__(5341).serializeInteger;
/* unused reexport */ __webpack_require__(5341).parseURL;
...
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5687);
/* harmony import */ var zlib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9796);
...
/* harmony export */ });
/* harmony import */ var cross_fetch_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9571);
...
async function handler(req, res) {
  res.setHeader('Cache-Control', `public, max-age=${req.query.age ?? 5}, s-maxage=${req.query.sage ?? 15}, stale-while-revalidate=${req.query.swr ?? 30}`);
  const data = await (await fetch('http://worldtimeapi.org/api/timezone/Europe/Dublin')).json();
