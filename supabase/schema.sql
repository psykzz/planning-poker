...
drop function if exists public.cleanup_stale_sessions(integer);
...
create index cleanup_logs_cleaned_at_idx on public.cleanup_logs (cleaned_at desc);
...
-- Run cleanup nightly. Re-running this schema keeps a single scheduled job.
